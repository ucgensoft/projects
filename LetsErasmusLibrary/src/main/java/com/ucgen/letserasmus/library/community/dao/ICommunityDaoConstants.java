...
public interface ICommunityDaoConstants {
	...
	String CREATE_COMMUNITY_TOPIC_SQL = "INSERT INTO COMMUNITY_TOPIC (COMMUNITY_GROUP_ID, USER_ID, TITLE, DESCRIPTION, SUB_URL, LAST_ACTIVITY_DATE, CREATED_BY, CREATED_DATE) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
