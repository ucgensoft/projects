...
public class UrlRewriteConfig extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/community/{communityGroupSubUrl}").to("/pages/CommunityTopicList.html?communityGroupSubUrl={communityGroupSubUrl}"))
				.addRule(Join.path("/community/topic/{communityTopicSubUrl}").to("/pages/CommunityTopic.html?communityTopicSubUrl={communityTopicSubUrl}"))
