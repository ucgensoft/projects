...
public class UrlRewriteConfig extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/universities/").to("/pages/Universities.html"))
				.addRule(Join.path("/community").to("/pages/CommunityGroup.html"))
				.addRule(Join.path("/community/{communityGroupSubUrl}").to("/pages/CommunityGroup.html?communityGroupSubUrl={communityGroupSubUrl}"))
				.addRule(Join.path("/community/{communityGroupSubUrl}/{communityTopicSubUrl}").to("/pages/CommunityTopic.html?communityTopicSubUrl={communityTopicSubUrl}&communityGroupSubUrl={communityGroupSubUrl}"))
