...
public class ImageUtil {
	...
	public static void resizeImage(String originalImagePath, String resizedImagePath, Size size, Integer rotationDegree) throws IOException {
	...
	public static void resizeImage(InputStream originalFileStream, String resizedImagePath, Size size, Integer rotationDegree) throws IOException {
		
		BufferedImage originalImage = ImageIO.read(originalFileStream);
		resizeImage(originalImage, resizedImagePath, size, rotationDegree);
	}
	
	public static void resizeImage(File originalFile, String resizedImagePath, Size size, Integer rotationDegree) throws IOException {
		
		BufferedImage originalImage = ImageIO.read(originalFile);
		resizeImage(originalImage, resizedImagePath, size, rotationDegree);
	}
	
	private static void resizeImage(BufferedImage originalImage, String resizedImagePath, Size size, Integer rotationDegree) throws IOException {
    ...
    public static BufferedImage rotate(Image img, double angle) throws IOException{
        ...
        g.dispose();
        return bimg;
        //ImageIO.write(bimg, "png", new File("D:\\tmp\\image_operations\\Capture_rotated.png"));
        //return toImage(bimg);
    }
